...
public class Direcciones  implements java.io.Serializable {
    ...
    public Direcciones(int fkCedula, String nomLugar, String direccion) {
        this.fkCedula = fkCedula;
        this.nomLugar = nomLugar;
        this.direccion = direccion;
    }
    public Direcciones(int fkCedula, String nomLugar, String direccion, String ultUsuario, Date ultModificacion) {
       this.fkCedula = fkCedula;
       this.nomLugar = nomLugar;
       this.direccion = direccion;
    ...
    public int getFkCedula() {
        return this.fkCedula;
    }
    
    public void setFkCedula(int fkCedula) {
        this.fkCedula = fkCedula;
    }
